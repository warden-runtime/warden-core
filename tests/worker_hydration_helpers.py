...
async def seed_forward_step(
    *,
    ...
    prompt_definition: str | None = "frozen prompt {{ name }}",
    worker: str = "test-worker",
    worker_version: str = "1.0.0",
    tools_allow: list | None = None,
    tools_bind: list | None = None,
    ...
    step = await SagaStepInstance.create(
        ...
        tools_bind=tools_bind or [],
        resources_allow=resources_allow or [],
        parameters_spec={},
        resolved_arguments={},
        prompt_ref=prompt_ref,
        prompt_definition=prompt_definition if step_kind == "reason" else None,
